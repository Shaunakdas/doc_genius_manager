...
ActiveRecord::Schema.define(version: 20210228072633) do
  ...
  create_table "game_holder_actions", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_game_holder_actions_on_user_id"
  end
  ...
  create_table "game_sessions", force: :cascade do |t|
    ...
    t.bigint "game_level_id"
    t.bigint "game_holder_session_id"
    t.index ["game_holder_id"], name: "index_game_sessions_on_game_holder_id"
    t.index ["game_holder_session_id"], name: "index_game_sessions_on_game_holder_session_id"
  ...
  create_table "user_game_themes", force: :cascade do |t|
    t.bigint "game_theme_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["game_theme_id"], name: "index_user_game_themes_on_game_theme_id"
    t.index ["user_id"], name: "index_user_game_themes_on_user_id"
  end
  ...
  add_foreign_key "game_sessions", "game_holder_sessions"
  ...
  add_foreign_key "user_game_themes", "game_themes"
  add_foreign_key "user_game_themes", "users"
